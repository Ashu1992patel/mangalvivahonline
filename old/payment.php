...
<head>
  ...
  <title>Mangal Vivah | Payment</title>
                      ...
                      <tr>
                        <td>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td colspan="2" align="left" valign="top">
                                      <p>
                                        ...
                                        <strong>
                                          <p class="style9"><strong>We offer payment options to pay us</strong></p>
                                        </strong>
                                      </p>
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td width="24%" align="center" valign="middle">
                                      <div class="pm-button"><a href="https://www.payumoney.com/paybypayumoney/#/308811"><img src="http://mangalvivahonline.com/images/online.jpg" /></a></div>
                            ...
                            <tr>
                              <td colspan="2" align="left" valign="top">
                                <p class="twobig"> Personal Cheque / Demand Draft </p>
                              </td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td width="76%" align="left" valign="top">
                                <p align="justify"> You can&nbsp; make payment by sending personal cheque/ demand draft in favour of <span class="sitename">Mangal Vivah </span>services &nbsp;Payable at Jabalpur.</p>
                                ...
                                <p class="style9"><strong>Mangal Vivah Services</strong></p>
                                <p align="left"> <br />
                                  <br />
                                  <br />
                                  <br />
                                ...
                                <p align="left">Email:<a href="mailto:mangalmandap@gmail.com" class="forgot"> mangalmandap@gmail.com</a></p>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td colspan="2" align="left" valign="top">
                                <p>You can direct deposit the&nbsp;<span class="style9">cheque, cash or transfer payment online</span>&nbsp;at any branch of &nbsp;<span class="style9"><strong>State Bank of India</strong></span><strong>.</strong></p>
                            ...
                            <tr>
                              <td colspan="2" align="left" valign="top">
                                ...
                                <table width="100%" align="center" cellpadding="0" cellspacing="0" class="borderbottom">
                                  <tr>
                                    <td width="32%" height="25" align="left" valign="middle" bgcolor="#962A66">
                                      <p class="onebig"><strong>State Bank of India</strong></p>
                                    </td>
                                    <td height="20" colspan="2" valign="top" bgcolor="#962A66">
                                      <p class="onebig"><strong>Jabalpur</strong></p>
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td width="24%" valign="top">
                                      <p align="left"><strong>Account Number </strong></p>
                                    </td>
                                    <td width="44%" valign="top">
                                      <p align="left"><strong>36751854429</strong></p>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td valign="top">
                                      <p align="left"><strong>Account Name </strong></p>
                                    </td>
                                    <td valign="top">
                                      <p align="left"> <strong>Mangal Vivah Matrimony </strong> </p>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td valign="top">
                                    ...
                                    <td valign="top">
                                      <p><strong>SBIN0001398</strong></p>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td valign="top">
                                      <p align="left"><strong>Branch Name </strong></p>
                                    </td>
                                    <td valign="top">
                                      <p align="left"><strong>TULARAM CHOWK, STATE BANK OF INDIA, JABALPUR</strong></p>
                                    </td>
                                  </tr>
                                  <tr>
