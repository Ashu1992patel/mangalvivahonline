                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td width="100%" align="left" valign="top">
                                      <p class="onebig1"> Administrator Login here </p>
                                    </td>
                                  </tr>
                                  <tr>
                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td width="7%" align="left">
                                                <p>
                                                  <input title="Login" accesskey="13" onclick="return validateFields()" tabindex="3" type="submit" src="images/go1.gif" name="login" value="Login" width="14" height="14" border="0" style="border:none" />
                                                </p>
                                              </td>
