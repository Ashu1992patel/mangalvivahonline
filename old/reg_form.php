<tr>
  <td>
    <form action="" method="post" name="form1" id="form1" onsubmit="javascript:return validateFields()">
      <table width="98%" border="0" align="center" cellpadding="1" cellspacing="1">
        ...
        <tr valign="top">
          <td height="21" colspan="2">
            <p class="style12">Welcome to mangalvivahonline.com Create your matrimonial profile to find your match. <span class="txthead">Please complete the form below to register your profile</span><span class="style13">. </span></p>
          </td>
        </tr>
        <tr valign="top">
          <td width="203">&nbsp;</td>
          <td width="710" align="right">
            <p><span class="style14">All fields are mandatory </span></p>
          </td>
        </tr>
        <tr valign="top">
          <td height="26" colspan="2" bgcolor="#9A005A" class="txtmain">
            <p><span class="onebig"><strong>Account Details</strong> </span>
        ...
        <tr valign="top">
          <td height="24" align="right">
            <p><strong>Choose Password</strong></p>
          </td>
          <td height="24">
            <p><strong>
        ...
        <tr valign="top">
          ...
          <td height="24">
            <p><strong>
              ...
              </strong><span class="style14">Set Password more then 5 Characters </span></p>
          </td>
        </tr>
        ...
        <tr valign="top">
          <td height="24" colspan="2" bgcolor="#9A005A">
            <p><span class="onebig"><strong>Personel Detail </strong></span>
              <font color="#CCCCCC"> ----------------------------------------------------------------------------------------------------------</font>
            </p>
          </td>
        </tr>
        ...
        <tr valign="top">
          <td height="24" align="right">
            <p><span class="style18">Name</span></p>
          </td>
          <td height="24">
            <p><strong>
        ...
        <tr>
          <td height="30" align="right" valign="top">
            <p class="style12">D.O.B.</p>
          </td>
          <td height="30" align="left" valign="top">
            <p>
              <font color="#000000" size="1" face="Verdana," arial,="Arial," sans-serif,="sans-serif," tahoma="Tahoma">
        ...
        <tr valign="top">
          <td height="26" align="right">
            <p class="style12">Marital Status </p>
          </td>
          <td height="26">
        ...
        <tr>
          <td height="26" align="right">
            <p class="style12">No. of Children</p>
          </td>
          <td height="26" align="left">
            <p><strong>
              ...
              </span>Not living with me<span class="style18">&nbsp;&nbsp;</span>
            </p>
          </td>
        </tr>
        <tr valign="top">
          <td height="24" align="right">
            <p><span class="style18">Religion</span></p>
          </td>
          <td height="24">
            <p>
        ...
        <tr valign="top">
          <td height="24" align="right">
            <p><span class="style18">Caste / Division</span></p>
          </td>
          <td height="24">
            <p>
              <select name="caste" id="caste">
                ...
                <OPTION VALUE='Christian - Church of South India'>Christian - Church of South India</Option>
                ...
                <OPTION VALUE='Christian - Knanaya Catholic'>Christian - Knanaya Catholic</Option>
                <OPTION VALUE='Christian - Knanaya Jacobite'>Christian - Knanaya Jacobite</Option>
        ...
        <tr valign="top">
          ...
          <td height="24">
            <p>
              ...
              <font color="#000000" arial,="Arial," sans-serif,="sans-serif," tahoma="Tahoma"><span class="style27">No
                  <input name="manglik" type="radio" value="yes" />
                  Yes
                  <input name="manglik" type="radio" value="dnot know" />
                  Don't know </span></font>
            </p>
          </td>
        </tr>
        <tr valign="top">
          <td height="24" align="right">
            <p><span class="style18">Mother Tongue</span></p>
          </td>
          <td height="24">
            <p>
        ...
        <tr valign="top">
          <td height="24" colspan="2" align="left" bgcolor="#9A005A">
            <p><strong class="onebig">Education - Occupational Detail </strong>
              <font color="#CCCCCC"> ------------------------------------------------------------------------------</font>
            </p>
          </td>
        </tr>
          ...
          <td height="24">
            <p>
              <select name="education" id="education">
                ...
                <OPTION VALUE='Medicine - General/ Dental/ Surgeon/Engineering/CA/ Others'>Medicine - General/ Dental/ Surgeon/Engineering/CA/ Others</Option>
        ...
        <tr valign="top">
          <td height="24" colspan="2" align="left" bgcolor="#9A005A">
            <p><strong class="onebig">Contact Detail </strong>
              <font color="#CCCCCC"> ------------------------------------------------------------------------------------------------------------</font>
            </p>
          </td>
        </tr>
        <tr>
          <td align="right">
            <p class="style21"><strong>Residing State</strong></p>
          </td>
          <td align="left">
            <p>
        ...
        <tr>
          <td align="right">
            <p class="style21"><strong>City</strong></p>
          </td>
          <td align="left">
            <p>
        ...
        <tr>
          <td height="77" align="right" valign="top">
            <p class="style21"><strong>Contact Address</strong></p>
          </td>
          <td align="left">
            <p>
        ...
        <tr>
          <td height="50" align="right">
            <p class="style21"><strong>Contact Phone</strong></p>
          </td>
          <td align="left">
            <p><span class="style14"><img width="1" height="1" src="RegistrationOne_clip_image001_0001.php" /> &nbsp;&nbsp;Mobile Number </span><br />
        ...
        <tr valign="top">
          <td align="right">
            <p><strong>Country Living in </strong></p>
          </td>
          <td>
            <p><span class="smalltxt">
        ...
        <tr valign="top">
          ...
          <td>
            <p><span class="smalltxt frmlftpad">
        ...
        <tr valign="top">
          ...
          <td>
            <p>
              ...
              <font face="Verdana," arial,="arial," sans-serif,="sans-serif," tahoma="tahoma" color="#FF0000" size="1"> </font>
              <font color="#666666" size="1" face="Verdana," class="style10" arial,="arial," sans-serif,="sans-serif," tahoma="tahoma">Please tick this box to indicate that you have read and agree
                to the <a href="T%26C.php" target="_blank" class="style10">Terms
                  &amp; Conditions</a> of Service</font>
            </p>
          </td>
        </tr>
        <tr valign="top">
