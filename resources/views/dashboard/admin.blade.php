...
@section('content')
  <div class="dash_head">
    <div class="dash_txt">Welcome to Mangal Vivah</div>
    <div class="dash_time">
  ...
  <div class="col-md-12 seperate ">
    ...
    {{-- <table width="100%" border="0" align="left">
              ...
              <tr>
                  ...
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td></td> --}}{{-- <td><a href="http://www.monkeyjobs.in/admin/profiles_lists"></a></td> --}}{{-- </tr>
              <tr>
                  ...
                  <td align="center"><a href="category" class="a_txt"><i
                          ...
                          <h4>Category</h4></a></td> --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/invite_employer"><i --}}{{--  --}}{{-- class="fa awesome_style fa-envelope"></i><br> --}}{{--  --}}{{-- Invite Employer</a></td> --}}{{--  --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/invite_jobseeker"><i --}}{{--  --}}{{-- class="fa awesome_style fa-users"></i> <br> --}}{{--  --}}{{-- Invite Jobseeker</a></td> --}}{{--  --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/email_template"><i --}}{{--  --}}{{-- class="fa fa-envelope awesome_style"></i><br> --}}{{--  --}}{{-- Email Templates</a></td> --}}{{--  --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/ads"><i --}}{{--  --}}{{-- class="fa awesome_style fa-bullhorn"></i><br> --}}{{--  --}}{{-- Ads</a></td> --}}{{-- </tr>
              <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
              ...
              <tr>
                  <td align="center"><a href="{{url('policy')}}" class="a_txt"><i
                                  class="fa awesome_style animated-hover faa-tada faa-fast fa-calendar-check-o"></i><br>
                          <h4>Policy</h4></a></td> --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/institute"><i --}}{{--  --}}{{-- class="fa awesome_style fa-university"></i><br> --}}{{--  --}}{{-- Institute</a></td> --}}{{--  --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/salary"><i --}}{{--  --}}{{-- class="fa awesome_style fa-money"></i> <br> --}}{{--  --}}{{-- Salary</a></td> --}}{{--  --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/qualification"><i --}}{{--  --}}{{-- class="fa  awesome_style fa-graduation-cap">&nbsp;</i><br> --}}{{--  --}}{{-- Qualification</a></td> --}}{{--  --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/prohibited_keyword"><i --}}{{--  --}}{{-- class="fa awesome_style fa-tags"></i><br> --}}{{--  --}}{{-- Manage Prohibited Keywords</a></td> --}}{{-- </tr> --}}{{-- <tr> --}}{{--  --}}{{-- <td align="center">&nbsp;</td> --}}{{--  --}}{{-- <td align="center">&nbsp;</td> --}}{{--  --}}{{-- <td align="center">&nbsp;</td> --}}{{--  --}}{{-- <td align="center">&nbsp;</td> --}}{{--  --}}{{-- <td align="center">&nbsp;</td> --}}{{--  --}}{{-- </tr> --}}{{--  --}}{{-- <tr> --}}{{--  --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/skills"><i --}}{{--  --}}{{-- class="fa awesome_style fa-tags"></i><br> --}}{{--  --}}{{-- Manage Skills</a></td> --}}{{--  --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/manage_newsletters"><i --}}{{--  --}}{{-- class="fa fa-envelope awesome_style"></i><br> --}}{{--  --}}{{-- Manage Newsletters</a></td> --}}{{--  --}}{{-- <td align="center"><a href="http://www.monkeyjobs.in/admin/job_alert_queue"><i --}}{{--  --}}{{-- class="fa fa-envelope awesome_style"></i><br> --}}{{--  --}}{{-- Job Alert Queue</a></td> --}}{{--  --}}{{-- <td align="center"></td> --}}{{--  --}}{{-- <td align="center"></td> --}}{{--  --}}{{-- </tr> --}}{{--  --}}{{-- <tr> --}}{{--  --}}{{-- <td align="center">&nbsp;</td> --}}{{--  --}}{{-- <td align="center">&nbsp;</td> --}}{{--  --}}{{-- <td align="center">&nbsp;</td> --}}{{--  --}}{{-- <td align="center">&nbsp;</td> --}}{{--  --}}{{-- <td align="center">&nbsp;</td> --}}{{--  --}}{{-- </tr> --}}{{-- </tbody>
          </table>
      </div> --}}
