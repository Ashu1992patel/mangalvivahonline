...
<body onload="submitPayuForm()">
  ...
  <form method="post" target="_blank" name="payumoney" action="https://secure.payu.in/_payment"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3"><label for=""><b>Rs. {{ $totalCost }}&nbsp;({{ $amt }} +
            ...
            <input type="hidden" readonly="readonly" class="form-control" name="amount" value="{{ $totalCost }}"
              id="inputType" placeholder="Enter Amount">
          </div>
          ...
          <div class="col-sm-3"><label for=""><b><?php echo $new_str; ?></b></label>
            <input type="hidden" readonly="readonly" value="<?php echo $new_str; ?>" name="firstname" class="form-control"
              id="inputType" placeholder="Enter Name">
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-3"><label for=""><b>{{ $email }}</b></label>
            <input type="hidden" readonly="readonly" name="email" value="{{ $email }}" class="form-control"
              id="inputType" placeholder="Enter Email">
          </div>
          ...
          <div class="col-sm-3"><label for=""><b>{{ $mobile }}</b></label>
            <input type="hidden" readonly="readonly" name="phone" value="{{ $mobile }}" class="form-control"
              id="inputType" placeholder="Enter Phone">
          </div>
        </div>
      </div>
      <p class="clearfix"></p>
      ...
      <div class="col-md-12 hidden">
        <div class="form-group">
          <label for="inputType" class="col-md-2 control-label">Failure URL:<span
              class="mandatory">*</span></label>
          <div class="col-md-8"><input type="text" name="furl" value="{{ url('failed') }}" class="form-control"
              placeholder="Enter Failure URL"></div>
        </div>
      </div>
      <div class="col-md-12 hidden">
        <div class="form-group">
