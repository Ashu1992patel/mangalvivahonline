...
<input type="hidden" id="glo_share_detail"
  value="Mangal Vivah is a leading Indian matrimonial matchmaking service provider. Our team is committed to provide 360 degree solutions to all prospective Indian brides and grooms for marriage. " />
          ...
          <div class="login_with_baskit">
            @if (isset($_SESSION['user_master']))
              ...
              <ul class="menu_ul" id="after_login_ul">
                ...
                {{-- </li> --}}
                <li>
                  <a href="{{ url('candidate_list') }}"> <i class="mdi mdi-home"></i>Home</a>
                </li>
                <li><a href="{{ url('userProfiles') }}">
                    <i class="mdi mdi-account-switch"></i>Inbox
                    <span
                      class="badge">{{ isset($interest_count->interest_count) ? $interest_count->interest_count : '0' }}</span></a>
                </li>
                    ...
                    <div class="menu_basic_popup scale0">
                      <div class="menu_popup_containner padding0">
                        ...
                        <div class="menu_popup_settingrow effect">
                          <a onclick="search_by_id();" data-toggle="modal" data-target="#myModal"
                  ...
                  <div class="profile_user glo_menuclick">
                    ...
                    <div class="menu_basic_popup scale0">
                      <div class="menu_popup_containner padding0">
                        ...
                        <div class="menu_popup_settingrow effect">
                          <a onclick="aadhar();" data-toggle="modal" data-target="#myModal" class="menu_setting_row">
                            <i class="mdi mdi-account-search"></i>
                            Aadhar
                          </a>
                        </div>
                        <div class="menu_popup_settingrow effect">
                          <a onclick="privacy_control();" data-toggle="modal" data-target="#myModal"
                            class="menu_setting_row">
                        ...
                        <div class="menu_popup_settingrow effect">
                          <a onclick="update_password();" data-toggle="modal" data-target="#myModal_UpdatePassword"
                            class="menu_setting_row">
                            <i class="mdi mdi-lock-open-outline"></i>
                            Change Password
                          </a>
              ...
              <ul class="menu_ul">
                ...
                <li>
                  <a href="{{ url('a_registration') }}">
                    <i class="mdi mdi-account-edit"></i>Registration</a>
                </li>
                <!-- <li >
  ...
  <div class="login_popup_box">
    ...
    <div class="login_right_txt">
      <div class="right_block login" style="display: none;">
        <div class="deli_row">
          <input type="text" name="email_pass" autocomplete="off" class="form-control login_txt" placeholder="Email id "
            id="login_mobile">
        </div>
        <div class="deli_row">
        ...
        <div class="product_btn_box">
          ...
          {{-- </a> --}}
          <div class="btn btn-info btn-sm pull-center" style="margin-left: 5px;" onclick="ShowLoginSignup('verify')">
      ...
      <div class="right_block forgot">
        <div class="deli_row">
          <input type="text" name="email_pass" autocomplete="off" id="fcontact_no" class="form-control login_txt"
      ...
      <div class="right_block registration" style="display: block;">
        ...
        <div class="deli_row">
          <input type="text" name="reg_number" autocomplete="off" id="c_contact" class="form-control login_txt"
      ...
      <div class="modal-body">
        <div class="basic_lb_row">
          <div class="textbox_containner">
            <input type="text" class="animate_txt" name="txtChange_previousPsd" id="txtChange_previousPsd"
        ...
        <div class="basic_lb_row">
          <div class="textbox_containner">
            <input type="text" class="animate_txt" name="txtchange_newPsd" id="txtchange_newPsd" autocomplete="off"
        ...
        <div class="basic_lb_row">
          <div class="textbox_containner">
            <input type="text" class="animate_txt" name="txtchange_retypePsd" id="txtchange_retypePsd"
              autocomplete="off" data-validate="txtchange_retypePsd">
  ...
  function getContactUs() {
    ...
    if (c_name == '') {
      ...
      $.ajax({
        type: "get",
        url: "{{ url('contact_us') }}",
        data: "c_name= " + c_name + "&c_looking_for= " + c_looking_for + "&c_email= " + c_email + "&c_contact= " +
          c_contact,
        success: function(data) {
          HidePopoupMsg();
          if (data == "success") {
    ...
    if (!result) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if (data == "Invalid") {
            HidePopoupMsg();
            //ShowErrorPopupMsg('Email or Password is invalid');Mangal Vivah
            ShowLoginSignup('signin');
            swal("Oops....", "Email or Password is invalid", "info");
          } else if (data == "Inactivate") {
            swal("Oops....",
              "Your account is deactivated by admin, Please contact to Mangal Vivah admin(7354933132)", "info");
          } else if (data == "NotVerified") {
            swal("Oops....",
              "Your account in not verified, verification code has been sent to your registered mobile no",
              "info");
          } else {
            HidePopoupMsg();
    ...
    if (!result) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if (data == 'ok') {
            swal("Success....", "Password has been sent to your registered email address successfully",
              "success");
  ...
  function submitChange() {
    ...
    if (newpassword.trim() == '') {
      ...
      $.ajax({
        ...
        data: '{"newpassword":"' + newpassword + '", "confirmpassword":"' + confirmpassword + '", "oldpassword":"' +
          oldpassword + '"}',
        success: function(data) {
          if (data == 'ok') {
            //                        console.log(data);
