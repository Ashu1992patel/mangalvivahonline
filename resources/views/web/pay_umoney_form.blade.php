...
<body onload="submitPayuForm()">
  ...
  <form method="post" name="payumoney" target="_blank" action="https://secure.payu.in/_payment"
    id="payumoney_form_btnblock">
    @csrf
    <div class="container">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <div class="col-sm-3"><label for=""><b>Rs. {{ $totalCost }}&nbsp;({{ $amt }} +
                {{ $amt_pum }})</b></label>
            <input type="hidden" readonly="readonly" class="form-control" name="amount" value="{{ $totalCost }}"
              id="amtall" placeholder="Enter Amount">
          </div>
          <label for="inputType" class="col-md-1 control-label">Name<span class="mandatory">*</span></label>
          <div class="col-sm-3"><label for=""><b>{{ str_replace(' ', '', $user->name) }}</b></label>
            <input type="hidden" readonly="readonly" value="{{ str_replace(' ', '', $user->name) }}" name="firstname"
              class="form-control" id="fname" placeholder="Enter Name">
          </div>
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <div class="col-sm-3"><label for=""><b>{{ $email }}</b></label>
            <input type="hidden" readonly="readonly" name="email" value="{{ $email }}" class="form-control"
          ...
          <div class="col-sm-3"><label for=""><b>{{ $mobile }}</b></label>
            <input type="hidden" readonly="readonly" name="phone" value="{{ $mobile }}" class="form-control"
      ...
      <div class="col-md-12">
        <div class="form-group">
          <label for="inputType" class="col-md-2 control-label">Plan<span class="mandatory">*</span></label>
          <div class="col-sm-3"><label
              for=""><b>{{ 'Rs. ' . $plan->amount . '(' . $plan->plan_name . ')' }}</b></label>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12 hidden">
        <div class="form-group">
          ...
          <div class="col-md-8">
            <input type="text" name="surl" class="form-control" value="{{ url('success') }}"
      ...
      <div class="col-md-12 hidden">
        <div class="form-group">
          <label for="inputType" class="col-md-2 control-label">Failure URL:<span
              class="mandatory">*</span></label>
          <div class="col-md-8"><input type="text" name="furl" value="{{ url('failed') }}"
      ...
      <div class="col-md-12 hidden">
        <div class="form-group">
          <label for="inputType" class="col-md-2 control-label">Product Info<span
              class="mandatory">*</span></label>
          <div class="col-md-10"><input name="productinfo" value="product" class="form-group" rows="5"
              cols="125" placeholder="Product information"></div>
          ...
          <input type="text" name="address1" value="<?php echo empty($posted['address1']) ? '' : $posted['address1']; ?> " />
          <input type="text" name="address2" value="<?php echo empty($posted['address2']) ? '' : $posted['address2']; ?>" />
          <input type="text" name="city" value="<?php echo empty($posted['city']) ? '' : $posted['city']; ?>" />
          <input type="text" name="state" value="<?php echo empty($posted['state']) ? '' : $posted['state']; ?>" />
          <input type="text" name="country" value="<?php echo empty($posted['country']) ? '' : $posted['country']; ?>" />
          <input type="text" name="zipcode" value="<?php echo empty($posted['zipcode']) ? '' : $posted['zipcode']; ?>" />
          ...
          <input type="text" name="udf4" value="<?php echo empty($posted['udf4']) ? '4' : $posted['udf4']; ?>" />
