            ...
            <div class="cand_view_detailsbox">
              <div class="tab" role="tabpanel">
                <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="active links"><a href="#section1" aria-controls="home" role="tab"
                      data-toggle="tab" aria-expanded="true">Personal
                      Details</a></li>
                  <li role="presentation" class=" links"><a href="#education" aria-controls="profile" role="tab"
                      data-toggle="tab" aria-expanded="false">Education</a>
                  </li>
                  <li role="presentation" class=" links"><a href="#section2" aria-controls="profile" role="tab"
                      data-toggle="tab" aria-expanded="false">Family
                      Details</a></li>
                  <li role="presentation" class=" links"><a href="#section3" aria-controls="messages" role="tab"
                      data-toggle="tab" aria-expanded="false">Partner
                      Expectations</a></li>
                </ul>
