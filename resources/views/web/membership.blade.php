                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 packages-section ">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12 final-price-section">
                            <div class="price-detail">
                              ...
                              <a href="#">
                                <button type="button" id="1" onclick="submitMembership(this)"
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 packages-section ">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12 final-price-section">
                            <div class="price-detail">
                              ...
                              <a href="#">
                                <button type="button" id="2" onclick="submitMembership(this)"
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 packages-section ">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12 final-price-section">
                            <div class="price-detail">
                              ...
                              <a href="#">
                                <button type="button" id="3" onclick="submitMembership(this)"
