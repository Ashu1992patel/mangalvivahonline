  ...
  @foreach ($users as $search_user)
    ...
    <div class="cand_box">
      ...
      <div class="cand_btnbox">
        <a class="btn-group cand_btncontainner" href="{{ url('view_profile') . '/' . $search_user->id }}">
          <button type="button" class="btn btn-primary btn-xs res_btn"><span class="mdi mdi-eye"></span></button>
        ...
        <div class="btn-group cand_btncontainner" data-content="{{ $search_user->id }}"
          ...
          <button type="button" class="btn btn-success btn-xs res_btn"><span class="mdi mdi-heart"></span></button>
        ...
        <button class="member_btn btn btn-default" onclick="unfriend('{{ $search_user->id }}')" id="unfriends_"
          style="display: none;">
    ...
    <div class="cand_box">
      ...
      <div class="cand_details">
        ...
        <ul class="cand_info">
          ...
          <li data-toggle="tooltip" data-placement="bottom" title="{{ $search_user->education }}">
            {{ \Illuminate\Support\Str::limit($search_user->education, 30) }}</li>
        </ul>
      </div>
      <div class="cand_btnbox">
        <a class="btn-group cand_btncontainner" href="{{ url('view_profile') . '/' . $search_user->id }}">
        ...
        @elseif($result[0]->status_ == 'SENDER')
          <div class="btn-group cand_btncontainner" data-content="{{ $search_user->id }}"
            ...
            <button type="button" class="btn btn-danger btn-xs res_btn"><span class="mdi mdi-close"></span></button>
        ...
        @elseif($result[0]->status_ == 'RECIEVER')
          <div class="btn-group cand_btncontainner" data-content="{{ $search_user->id }}"
            ...
            <button type="button" class="btn btn-success btn-xs res_btn"><span class="mdi mdi-check"></span></button>
        ...
        @elseif($result[0]->status_ == 'FRIENDS')
          <div class="btn-group cand_btncontainner" data-content="{{ $search_user->id }}"
            ...
            <button type="button" class="btn btn-default btn-xs res_btn"><span class="mdi mdi-eye"></span></button>
