      ...
      <div class="cand_box">
        ...
        <div class="cand_btnbox">
          <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
            <a class="popup_submitbtn btn-sm btn-primary" href="{{ url('view_profile') . '/' . $search_user->id }}">View
              Profile
            </a>
          </div>
          <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
    ...
    <div class="home_brics_row">
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="white_brics">
            <div class="white_icon_withtxt">
              <div class="white_icons_blk white_brics_clr2"><i class="mdi mdi-contact-mail"></i>
              </div>
        ...
        <div class="col-sm-4">
          <div class="white_brics">
            <div class="white_icon_withtxt">
              <div class="white_icons_blk white_brics_clr4"><i class="mdi mdi-account-card-details"></i></div>
