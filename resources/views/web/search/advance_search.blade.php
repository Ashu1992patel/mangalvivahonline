...
@section('title', 'Mangal Vivah :Advance Search')
@section('head')
    ...
    <div class="container">
      <div class="candidate_list_box">
        ...
        <div class="col-sm-12" style="background-color: white;">
          ...
          <form class="filter_form" action="{{ url('search_advance') }}" enctype="multipart/form-data" method="post">
            @csrf
            ...
            <div class="filter_data_box">
              <input checked type="checkbox" class="search_filter" name="marital_status[]" value="Never Married">
            ...
            <div class="filter_data_box">
              <div class="age_filterbox">
                <select name="occupation[]" class="typeDD" style="width:100%" multiple>
                  ...
                  <OPTION VALUE='Front Office/ Secretarial Staff/ Export/ Import'>Front Office/ Secretarial Staff/ Export/
                    Import</Option>
