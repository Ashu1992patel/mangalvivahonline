...
@section('title', 'Mangal Vivah :Desire Candidate List')
@section('head')
                  ...
                  <div class="cand_btnbox">
                    ...
                    <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                      <a href="#" data-content="{{ $search_user->id }}" id="send_{{ $search_user->id }}"
                        onclick="send_interest(this)" class="popup_submitbtn2 btn-sm btn-success">Send
                        Interest</a>
                    </div>
                    <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                ...
                @foreach ($users as $search_user)
                  ...
                  <div class="cand_box">
                    ...
                    <div class="cand_details">
                      <div class="cand_name" style="cursor: pointer;"
                        onclick="location.href='{{ url('view_profile') . '/' . $search_user->id }}';">
                        {{ $search_user->name }}{{ ' (MM-' . $search_user->id . ')' }}{{-- <span data-toggle="tooltip" data-placement="right" title="Verified Profile By Aadhar" class="glyphicon glyphicon-ok icon-success"></span> --}}</div>
                      <ul class="cand_info">
                        <li>{{ isset($search_user->age) ? $search_user->age : 'Not Specified' }}
                          Years
                        </li>
                        ...
                        <li data-toggle="tooltip" data-placement="bottom" title="{{ $search_user->occupation_detail }}">
                    ...
                    <div class="cand_btnbox">
                      ...
                      @if ($result[0]->status_ == 'NULL')
                        ...
                        <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                          <a href="#" data-content="{{ $search_user->id }}" id="send_{{ $search_user->id }}"
                            onclick="send_interest(this)" class="popup_submitbtn3 btn-sm btn-success">Send Interest</a>
                        </div>
