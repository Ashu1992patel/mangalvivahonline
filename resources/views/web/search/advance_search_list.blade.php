          ...
          @if (isset($_SESSION['user_master']))
            ...
            @if ($active->active != 'no' && $active->active != '' && $active->deactivated_at >= $today)
              ...
              <div class="left_info">
                ...
                <div class="profile_cand_name"><i class="mdi mdi-access-point fa-sm pr-2" aria-hidden="true"></i> Plan :
                  MM- {{ $active->plan }}
                </div>
                <div class="profile_cand_name"><i class="mdi mdi-clock fa-sm pr-2" aria-hidden="true"></i> Plan Expire :
                  {{ $active->deactivated_at }}
                </div>
                <div class="profile_cand_name"><i class="mdi mdi-contacts fa-sm pr-2" aria-hidden="true"></i>Contact Left
            ...
            <form action="{{ url('search_side') }}" enctype="multipart/form-data" method="post">
              ...
              <div class="filter_data_box">
                <input {{ isset($_SESSION['marital_status'][0]) ? 'checked' : 'checked' }} type="checkbox"
                  class="search_filter" name="marital_status[]" value="Never Married">
                &nbsp;&nbsp;<label class="label-checkbox">Never Married</label><br>
                <input {{ isset($_SESSION['marital_status'][1]) ? 'checked' : '' }} type="checkbox" class="search_filter"
                  name="marital_status[]" value="Divorced">
                &nbsp;&nbsp;<label class="label-checkbox">Divorced</label><br>
                <input {{ isset($_SESSION['marital_status'][2]) ? 'checked' : '' }} type="checkbox" class="search_filter"
                  name="marital_status[]" value="Widowed">
                &nbsp;&nbsp;<label class="label-checkbox">Widowed</label><br>
                <input {{ isset($_SESSION['marital_status'][3]) ? 'checked' : '' }} type="checkbox" class="search_filter"
              ...
              <div class="filter_data_box">
                <select name="family_income[]" id="family_income" class="typeDD" style="width:100%" multiple>
                  <option selected="selected" value="Any">Doesn't Matter</option>
                ...
                <div class="cand_box">
                  ...
                  <div class="cand_details">
                    <div class="cand_name" style="cursor: pointer;" data-content="{{ $search_user->id }}"
                      ...
                      {{ $search_user->name }}{{ '(MM' . $search_user->id . ')' }}</div>
                    <ul class="cand_info">
                      ...
                      <li data-toggle="tooltip" data-placement="bottom" title="{{ $search_user->education_detail }}">
                        {{ $search_user->education }}</li>
                    </ul>
                  </div>
                  <div class="cand_btnbox">
                    ...
                    <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                      <a href="#" data-content="{{ $search_user->id }}" id="send_{{ $search_user->id }}"
                        onclick="send_interest(this)" class="popup_submitbtn_lv btn-sm btn-success">Send
                        Interest</a>
                    </div>
                    <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                      <a href="#" data-content="{{ $search_user->id }}" id="view_{{ $search_user->id }}"
                        onclick="view_contact(this)" class="popup_submitbtn_lv btn-sm upgrade_bg">View Contact</a>
                    </div>
                  </div>
                </div>
              @endforeach
                  ...
                  <div class="cand_box">
                    ...
                    <div class="cand_btnbox">
                      ...
                      @if ($result[0]->status_ == 'NULL')
                        ...
                        <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                          <a href="#" data-content="{{ $search_user->id }}" id="send_{{ $search_user->id }}"
                            onclick="send_interest(this)" class="popup_submitbtn_lv btn-sm btn-success">Send Interest</a>
                        </div>
                      @elseif($result[0]->status_ == 'SENDER')
                        ...
                        {{-- </div> --}}
                        <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                          <a href="#" data-content="{{ $search_user->id }}" id="pending_{{ $search_user->id }}"
                            onclick="cancelrequest(this);" class="popup_submitbtn_cancel btn-sm btn-danger">Cancel
                            Interest</a>
                        </div>
                      @elseif($result[0]->status_ == 'RECIEVER')
                        ...
                        <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                          <a href="#" data-content="{{ $search_user->id }}" id="pending_{{ $search_user->id }}"
                            onclick="acceptfrequest(this);" class="popup_submitbtn btn-sm btn-success">Accept
                            Interest</a>
                        </div>
                      @elseif($result[0]->status_ == 'FRIENDS')
                        ...
                        {{-- </div> --}}
                        <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                          <a href="#" data-content="{{ $search_user->id }}" id="friends_{{ $search_user->id }}"
                      ...
                      <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                        <a href="#" data-content="{{ $search_user->id }}" id="view_{{ $search_user->id }}"
                          onclick="view_contact(this)" class="popup_submitbtn btn-sm btn-info">View Contact</a>
                      </div>
