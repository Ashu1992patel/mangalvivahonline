...
@section('content')
    ...
    <div class="banner_search_bg">
      <div class="container">
        <form id="searchFilter" method="post" class="banner_search_form">
          ...
          <div class="banner_block_search">
            <em>Age</em>
            <input name="age1" type="number" min="18" max="70" value="18" class="form-control banner_age_txt"
              placeholder="minimum">
            <input name="age2" type="number" min="18" max="70" value="25" class="form-control banner_age_txt"
              placeholder="maximum">
          </div>
          <div class="banner_block_search">
            <em>Religion</em>
      ...
      <div class="col-md-10 col-md-offset-1 col-sm-12">
        ...
        <div class="row">
          <div class="col-md-12 mt30 text-center"><a href="{{ url('membership') }}"
              class="btn btn-blue bor-r50 btn-big ripplelink" id="HP_Membership_CTA">Browse Membership Plans</a>
  ...
  <section class="eassy_staps_block">
    <div class="container">
      ...
      <div class="staps_block">
        <div class="col-sm-12">
          <p>
            Mangal Vivah is a leading Indian matrimonial matchmaking service provider.
  ...
  <section class="eassy_staps_block">
    ...
    {{-- <h3>ANTIMA  
         ...
         DIPESH</h3> --}}
    {{-- <p>“Hiii I am Dipesh Gautam I have registered our profile on mangalvivahonline.com after then I have receive some profiles form mangalmandap and after few month I have found better life partner in mangalvivahonline.com. Thank you so much team MangalMandap for providing better service.”</p> --}}
    {{-- </div> --}}
    {{-- </div> --}}
    {{-- </div> --}}
    {{-- <div class="item"> --}}
    ...
    {{-- personalized matchmaking service on Mangal Vivah and within 3 months we were --}}
    {{-- able --}}
    ...
    {{-- <p>“We had a seamless experience finding a perfect girl for Pushpak. We opted for personalized matchmaking service on Mangal Vivah and within 3 months we were able to finalize the match.” said Pushpak & Ruchi Parent.”</p> --}}
          ...
          <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <div class="panel panel-default">
              ...
              <span class="side-tab" data-target="#tab7" data-toggle="tab" role="tab" aria-expanded="false">
                <div class="panel-heading" role="tab" id="heading7" data-toggle="collapse" data-parent="#accordion"
              ...
              <div id="collapse7" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading7">
                <div class="panel-body">
                  ...
                  Hiii I am Dipesh Gautam I have registered our profile on mangalvivahonline.com after then I have receive
                  some
                  profiles form mangalmandap and after few month I have found better life partner in
                  mangalvivahonline.com.
                  Thank you so much team MangalMandap for providing better service.
                </div>
              </div>
            </div>
            <!-- / panel 7 -->
            ...
            <div class="panel panel-default">
              ...
              <span class="side-tab" data-target="#tab8" data-toggle="tab" role="tab" aria-expanded="false">
                <div class="panel-heading" role="tab" id="heading8" data-toggle="collapse" data-parent="#accordion"
              ...
              <div id="collapse8" class="panel-collapse collapse " role="tabpanel" aria-labelledby="heading8">
                <div class="panel-body">
                  <!-- Tab content goes here -->
                  We had a seamless experience finding a perfect girl for Pushpak. We opted for personalized matchmaking
                  service on Mangal Vivah and within 3 months we were able to finalize the match.” said Pushpak & Ruchi
                  Parent.
                </div>
              </div>
            </div>
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseOne" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
                  <!-- Tab content goes here -->
                  I would like to thank you mangalvivahonline.com After a long wait, the finalist me
                  through mangalvivahonline.com , I got my soulmate & After a long conversation we tired in
                  marriage bonds.
                </div>
              </div>
            </div>
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                <div class="panel-body">
                  <!-- Tab content goes here -->
                  A big thanks to mangalvivahonline.com platform, here we got perfect match. we found each
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                <div class="panel-body">
                  <!-- tab content goes here -->
                  We met through mangalvivahonline.com . Thank you so much mangalvivahonline.com for giving me
            ...
            <div class="panel panel-default">
              ...
              <span class="side-tab" data-target="#tab4" data-toggle="tab" role="tab" aria-expanded="false">
                <div class="panel-heading" role="tab" id="heading4" class="collapsed" data-toggle="collapse"
                  data-parent="#accordion" href="#collapse4" aria-expanded="false" aria-controls="collapse4">
              ...
              <div id="collapse4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading4">
                <div class="panel-body">
                  <!-- tab content goes here -->
                  Me and my wife had Gold membership of mangalvivahonline.com We were searching for a while
                  ...
                  decided to involve our parents. Mangal Vivah is amazing platform for searching your
            ...
            <div class="panel panel-default">
              ...
              <span class="side-tab" data-target="#tab5" data-toggle="tab" role="tab" aria-expanded="false">
                <div class="panel-heading" role="tab" id="heading5" class="collapsed" data-toggle="collapse"
                  data-parent="#accordion" href="#collapse5" aria-expanded="false" aria-controls="collapse5">
              ...
              <div id="collapse5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading5">
                <div class="panel-body">
                  <!-- tab content goes here -->
                  I meet with SANDEEP in mangalvivahonline.com Got married .thanks mangalvivahonline.com for
                  such
            ...
            <div class="panel panel-default">
              ...
              <span class="side-tab" data-target="#tab6" data-toggle="tab" role="tab" aria-expanded="false">
                <div class="panel-heading" role="tab" id="heading6" class="collapsed" data-toggle="collapse"
                  data-parent="#accordion" href="#collapse6" aria-expanded="false" aria-controls="collapse6">
              ...
              <div id="collapse6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading6">
                <div class="panel-body">
                  <!-- tab content goes here -->
                  I found my perfect match for life on mangalvivahonline.com Easy, simple and beautiful
                  matrimony
                ...
                <div class="tab-featured-image">
                  <div class="tab-content">
                    <div class="tab-pane  in active" id="tab7">
                      <img src="{{ url('images/succ1.jpg') }}" alt="tab7" class="img img-responsive">
                    </div>
                    <div class="tab-pane fade" id="tab8">

                      <img src="{{ url('images/sucess_story1.jpg') }}" alt="tab8" class="img img-responsive">
                    ...
                    <div class="tab-pane fade" id="tab4">
                      ...
                      <img src="{{ url('slider/LOKESH WEDS PRIYANKA.jpg') }}" alt="tab3" class="img img-responsive">

                    </div>
                    <div class="tab-pane fade" id="tab5">

                      <img src="{{ url('slider/PRATIMA WEDS SANDEEP.jpg') }}" alt="tab5" class="img img-responsive">

                    </div>
                    <div class="tab-pane fade" id="tab6">

                      <img src="{{ url('slider/RIYA THAKUR WEDS RAVI PRATAP SINGH.jpg') }}" alt="tab6"
                        class="img img-responsive">
