        ...
        <div class="form-wizard form-header-modarn form-body-material">
          ...
          <div class="form_allcontainer">
            <div class="form-wizard-steps form-wizard-tolal-steps-4">
              ...
              <div class="form-wizard-step">
                <div class="form-wizard-step-icon"><i class="mdi mdi-account-multiple" aria-hidden="true"></i>
                </div>
                <p>FAMILY DETAILS</p>
              </div>
              {{-- <div class="form-wizard-step"> --}}
            ...
            <fieldset style="display: block;">
                ...
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" editable="false" name="name" autocomplete="off"
                      class="animate_txt textWithSpace required" id="name" placeholder="Enter Full Name">
                    <label class="animate_placeholder" for="name">Full Name<span class="rq_color">*</span></label>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" editable="false" name="email" autocomplete="off" class="animate_txt email required"
                      id="email" placeholder="Enter Email">
                    <label class="animate_placeholder" for="email">Email<span class="rq_color">*</span></label>
                  </div>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" editable="false" name="contact" autocomplete="off"
                      class="animate_txt contact required numberOnly" id="contact" placeholder="Enter Primary No"
                      maxlength="12">
                ...
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" editable="false" name="dob" autocomplete="off" class="animate_txt dob required"
                      id="dob" placeholder="Date Of Birth" title="You can only edit once in a life this field"
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="textbox_containner">
                    <input type="text" name="city" autocomplete="off" class="animate_txt required" id="city"
                      placeholder="City">
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" name="address" autocomplete="off" class="animate_txt required" id="address"
                      placeholder="Address">
            ...
            <fieldset style="display: none;">
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-6">
                  <select name="horoscope_match" id="HoroscopeMatch_Partner" class="form-control requiredDD txt_wizard">
              ...
              <div class="row form-group">
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" editable="false" name="bop" autocomplete="off" class="animate_txt " id="bop"
                ...
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    ...
                    <input type="time" name="tob" autocomplete="off" class="animate_txt " id="tob"
                      placeholder="Time of Birth" title="Time of Birth" data-toggle="tooltip" data-placement="top">
                  </div>
                </div>
              </div>
              <div class="row form-group">
              ...
              <div class="row form-group">
                <div class="col-sm-6">
                  <select name="gender" class="form-control requiredDD txt_wizard"
                    title="You can only edit once in a life this field" data-toggle="tooltip" data-placement="top">
              ...
              <div class="row form-group">
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" editable="false" name="subcaste" autocomplete="off" class="animate_txt "
                      id="subcaste" placeholder="Subcaste">
            ...
            <fieldset style="display: none;">
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-6">
                  <select name="highest_degree" id="highest_degree" class="form-control requiredDD txt_wizard">
                ...
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" editable="false" name="college_name" autocomplete="off" class="animate_txt "
                      id="college_name" placeholder="College/School Name">
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" editable="false" name="job_location" autocomplete="off" class="animate_txt "
              ...
              <div class="row form-group">
                <div class="col-sm-6">
                  <select name="anual_income" id="anual_income" class="form-control requiredDD txt_wizard"
                    style="width:100%">
              ...
              <div class="row form-group">
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" editable="false" name="weight" autocomplete="off" class="animate_txt "
              ...
              <div class="row form-group">
                <div class="col-sm-6">
                  <select name="blood_group" class="form-control  txt_wizard" type="text" id="blood_group1">
            ...
            <fieldset style="display: none;">
              ...
              <div class="row form-group">
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" name="father_side_gotra" autocomplete="off" class="animate_txt "
                      id="father_side_gotra" placeholder="Father side gotra">
              ...
              <div class="row form-group">
                <div class="col-sm-6">
                  <div class="textbox_containner">
                    <input type="text" name="f_based" autocomplete="off" class="animate_txt " id="f_based"
            ...
            <fieldset style="display: none;">
              ...
              <div class="row form-group">
                <div class="col-sm-6">
                  <div class="col-sm-6">
                    <div class="textbox_containner">
                      <input type="number" min="18" max="90" name="p_agefrom" autocomplete="off" class="animate_txt "
                        id="p_agefrom" placeholder="From Age">
                      <label class="animate_placeholder" for="p_agefrom">From Age</label>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="textbox_containner">
                      <input type="number" min="18" max="90" name="p_ageto" autocomplete="off" class="animate_txt "
                        id="p_ageto" placeholder="To Age">
                ...
                <div class="col-sm-6">
                  <div class="col-sm-6">
                    <select name="p_heightfrom" id="Partner_heightfromid" class="form-control txt_wizard">
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-6">
                  <select name="p_salary" id="annual_income_partner" class="form-control  txt_wizard">
                    ...
                    <option value="INR 4 Lakh to 7 Lakh" label="INR 4 Lakh to 7 Lakh" selected="selected">INR 4 Lakh to 7
                      Lakh
                    </option>
              ...
              <div class="row form-group">
                <div class="col-sm-6">
                  <select name="blood_group" class="form-control  txt_wizard" type="text" id="blood_group">
                    <option value="Not mentioned" selected="selected"> Select Blood Group</option>
                    <option value="O+">O+</option>
                    <option value="A+">A+</option>
                    <option value="B+">B+</option>
              ...
              <div class="form-wizard-buttons">
                ...
                <input type="submit" id="submit_reg" style="display:none;" class="btn btn-submit" value="Done">
              </div>
            </fieldset>
          </div>
        </div>
