              ...
              <div class="cand_box cand_profile_containner">
                ...
                <div class="cand_details u_info">
                  ...
                  <ul class="cand_info">
                    ...
                    <li data-toggle="tooltip" data-placement="bottom" title="{{ $user->password }}">
                      {{ \Illuminate\Support\Str::limit($user->password, 28) }}</li>
                ...
                <div class="cand_btnbox u_btn">
                  ...
                  <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                    <a href="#" data-content="{{ $user->id }}" id="view_{{ $user->id }}"
                      onclick="view_user_contact('{{ $user->id }}')" class="popup_submitbtn btn-sm upgrade_bg">View
                      Contact</a>
                  </div>
                </div>
              </div>
