                        ...
                        <div class="cand_details">
                          ...
                          <ul class="cand_info">
                            ...
                            <li data-toggle="tooltip" data-placement="bottom"
                              ...
                              {{ \Illuminate\Support\Str::limit($search_user->education, 25) }}</li>
                          </ul>
                        </div>
                      ...
                      <div class="cand_box">
                        ...
                        <div class="cand_btnbox">
                          ...
                          @if ($result[0]->status_ == 'RECIEVER')
                            ...
                            <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                              <a href="#" data-content="{{ $search_user->id }}" id="pending_{{ $search_user->id }}"
                                onclick="acceptfrequest(this);" class="popup_submitbtn_cancel btn-sm btn-success">Accept
                                Interest</a>
                            </div>
                          @endif
                          {{-- <div class="btn-group cand_btncontainner" onclick="ShowLoginSignup('signin');"> --}}
                          ...
                          @if ($result[0]->status_ == 'FRIENDS')
                            ...
                            <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                              <a href="#" data-content="{{ $search_user->id }}" id="friends_{{ $search_user->id }}"
                                onclick="unfriend(this);" class="popup_submitbtn_unfriend btn-sm upgrade_bg">UnFriend</a>
                            </div>
                          @endif
                          <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                            <a href="#" data-content="{{ $search_user->id }}" id="view_{{ $search_user->id }}"
                              onclick="view_contact(this)" class="popup_submitbtn btn-sm btn-info">View
                              Contact</a>
                          </div>
                          {{-- <div class="btn-group cand_btncontainner" onclick="ShowLoginSignup('signin');"> --}}
                          {{-- <button type="button" class="btn btn-success btn-sm res_btn"><span --}}
