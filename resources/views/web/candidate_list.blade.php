                ...
                <div class="cand_box">
                  <div class="cand_imgbox">
                    @if ($search_user->is_show_pic == '1')
                      ...
                      @endif
                    @else
                      <img data-toggle="tooltip" data-placement="right" title="Send interest to view profile"
                        data-content="{{ $search_user->id }}" onclick="view_contact(this)" class="cand_img"
                  ...
                  <div class="cand_btnbox">
                    ...
                    <div class="btn-group cand_btncontainner">
                      <a href="#" data-content="{{ $search_user->id }}" id="send_{{ $search_user->id }}"
                        onclick="send_interest(this)" class="popup_submitbtn_send_without_lg btn-sm btn-success">
                        Send Interest</a>
                    </div>
                  ...
                  <div class="cand_box">
                    <div class="cand_imgbox" style="cursor: pointer;"
                      ...
                      @else
                        <img class="cand_img" data-toggle="tooltip" data-placement="right"
                          title="Send interest to view profile" src="{{ url('images/female_large_protected.jpg') }}" />
                      @endif
                    ...
                    <div class="cand_btnbox">
                      ...
                      @if ($result[0]->status_ == 'NULL')
                        ...
                        <div class="">
                          <a href="#" data-content="{{ $search_user->id }}" id="send_{{ $search_user->id }}"
                            onclick="send_interest(this)" class="popup_submitbtn btn-sm btn-success">Send Interest</a>
                        </div>
