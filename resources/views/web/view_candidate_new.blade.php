            ...
            <div class="col-md-9 col-sm-12 col-xs-12 width100 padd0">
              <div class="top_nav_fixed">
                <div class="view_fixed_nav">
                  <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="#view_about_blk" id="about" type="button"
                      class="tab_btn waves-effect waves-light selected_tabs"><i class="mdi mdi-account fa-sm pr-2"
                        aria-hidden="true"></i> About
                    </a>
                    <a href="#view_service_blk" type="button" class="tab_btn waves-effect waves-light"><i
                        class="mdi mdi-briefcase-check fa-sm pr-2" aria-hidden="true"></i>Education & Profession
                    </a>
                    <a type="button" href="#view_gallery_blk" class="tab_btn waves-effect waves-light"><i
                        class="mdi mdi-image fa-sm pr-2" aria-hidden="true"></i>Family
                      Details
                    </a>
                    <a type="button" href="#view_userreview_blk" class="tab_btn waves-effect waves-light"><i
                        class="mdi mdi-message-draw fa-sm pr-2" aria-hidden="true"></i> Desire Partner
                    </a>
                    <a type="button" href="#view_life_style" class="tab_btn waves-effect waves-light"><i
                        class="mdi mdi-message-draw fa-sm pr-2" aria-hidden="true"></i> Life Style
                    </a>
                  </div>
                </div>
              </div>
              <div class="cand_box cand_profile_containner">
                ...
                <div class="cand_details u_info">
                  ...
                  <ul class="cand_info">
                    ...
                    <li data-toggle="tooltip" data-placement="bottom" title="{{ $user->education_detail }}">
                      {{ \Illuminate\Support\Str::limit($user->education, 28) }}</li>
                ...
                <div class="cand_btnbox u_btn">
                  @if (isset($_SESSION['user_master']))
                    ...
                    @elseif($result[0]->status_ == 'SENDER')
                      <div class="btn-group cand_btncontainner">
                        <a href="#" data-content="{{ $user->id }}" id="pending_{{ $user->id }}"
                          onclick="cancelrequest(this);" class="popup_submitbtn btn-sm btn-danger">Cancel
                          Interest</a>
                      </div>
                    @elseif($result[0]->status_ == 'RECIEVER')
                      <div class="btn-group cand_btncontainner">
                        <a href="#" data-content="{{ $user->id }}" id="pending_{{ $user->id }}"
                          onclick="acceptfrequest(this);" class="popup_submitbtn btn-sm btn-success">Accept Interest</a>
                      </div>
                    @elseif($result[0]->status_ == 'FRIENDS')
                      <div class="btn-group cand_btncontainner">
                        <a href="#" data-content="{{ $user->id }}" id="friends_{{ $user->id }}"
                          onclick="unfriend(this);" class="popup_submitbtn btn-sm upgrade_bg">UnFriend</a>
                      </div>
                    @else
                    @endif
                  ...
                  <div class="btn-group cand_btncontainner" style="margin-bottom: 25px;">
                    <a href="#" data-content="{{ $user->id }}" id="view_{{ $user->id }}"
                      onclick="view_contact(this)" class="popup_submitbtn btn-sm upgrade_bg">View Contact</a>
                  </div>
                </div>
              </div>
              <div class="card view_card" id="view_about_blk">
                ...
                <div class="card-body">
                  ...
                  <p>
                    <b><i class="mdi mdi-image fa-sm pr-2" aria-hidden="true"></i>About
                      Family:</b> <br>{{ isset($user->about_fam) ? $user->about_fam : 'Not mentioned' }}
                  </p>
                  <p>
                    <b><i class="mdi mdi-briefcase-check fa-sm pr-2" aria-hidden="true"></i>Education:</b><br>
                    {{ isset($user->education_detail) ? $user->education_detail : 'Not mentioned' }}
                  </p>
                  <p>
                        ...
                        <li>
                          @if (isset($user->education))
                            <a data-toggle="tooltip" data-placement="bottom"
                              title="{{ $user->education }}">{{ \Illuminate\Support\Str::limit($user->education, 25) }}</a>
                          @else
                            {{ 'Not mentioned' }}
                          @endif
                        </li>
                ...
                <div class="card-body pad_botttom0">
                  <div class="col-sm-6">
                    <ul class="cand_info view_details_box">
                      ...
                      <li>
                        {{ isset($user->father_occupation) ? \Illuminate\Support\Str::limit($user->father_occupation, 25) : 'Not mentioned' }}
                      </li>
                ...
                <div class="card more_details">
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled view_more_details_ul">
                      ...
                      <li>
                        {{ isset($user->horoscope_match) ? ($user->horoscope_match == 1 ? 'Must' : 'Not Necessary') : 'Not mentioned' }}
                      </li>
                      <li>Rashi</li>
