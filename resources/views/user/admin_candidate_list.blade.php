              ...
              <div class="cand_details">
                <div class="cand_name" style="cursor: pointer;">
                  ...
                  @if ($search_user->is_active == 1)
                    <button type="button" id="{{ $search_user->id }}" class="btn btn-xs btn-danger btnDelete"
                      title="Mark as Hold"><span class="fa fa-trash-o" aria-hidden="true"></span></button>
                  @else
                    <button type="button" id="{{ $search_user->id }}" class="btn btn-xs btn-success btnActive"
                      title="Mark as Unhold"><span class="fa fa-check-circle" aria-hidden="true"></span></button>
                  @endif
                ...
                <ul class="cand_info">
                  ...
                  <li data-toggle="tooltip" data-placement="bottom" title="Email">
                    {{ \Illuminate\Support\Str::limit($search_user->email) }}
                  </li>

                  <li data-toggle="tooltip" data-placement="bottom" title="Password">{{ $search_user->password }}</li>
                </ul>
              </div>
              <div class="cand_btnbox">
                ...
                <div class="btn-group cand_btncontainner">
                  ...
                  @if (isset($contact) && $contact->contact_left > 0)
                    ...
                    <div class="profile_cand_name"><b><i class="mdi mdi-access-point fa-sm pr-2" aria-hidden="true"></i>
                        Plan</b> :
                      MM- {{ $active->plan }}
                    </div>
                    <div class="profile_cand_name"><b><i class="mdi mdi-clock fa-sm pr-2" aria-hidden="true"></i> Plan
                        Activate</b> :
                  ...
                  @else
                    <a onclick="getPaidUser({{ $search_user->id }})"
                      class="popup_submitbtn_view btn-sm btn-success">Mark
                      as paid
                      {{-- <button type="button" class="btn btn-primary btn-xs res_btn"><span --}}
                      {{-- class="mdi mdi-eye"></span></button> --}}
                      {{-- <button type="button" class="btn btn-primary btn-xs res_btn">View Profile --}}
                  ...
                  @endif
                  <div class="profile_cand_name"><b><i class="mdi mdi-clock fa-sm pr-2" aria-hidden="true"></i> Signup
                      Date</b> :
