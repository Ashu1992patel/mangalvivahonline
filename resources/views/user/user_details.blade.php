                ...
                <div class="form_allcontainer">
                  <div class="form-wizard-steps form-wizard-tolal-steps-4">
                    ...
                    <div class="form-wizard-step active">
                      <div class="form-wizard-step-icon"><i class="mdi mdi-silverware" aria-hidden="true"></i></div>
                      <p>Restuarent</p>
                    </div>
                    <div class="form-wizard-step">
                      <div class="form-wizard-step-icon"><i class="mdi mdi-truck-delivery" aria-hidden="true"></i>
                      </div>
                      <p>Delivery </p>
                    </div>
                    <div class="form-wizard-step">
                      <div class="form-wizard-step-icon"><i class="mdi mdi-food-fork-drink" aria-hidden="true"></i>
                      </div>
                      <p>Cusinis</p>
                    </div>
                    <div class="form-wizard-step">
                      <div class="form-wizard-step-icon"><i class="mdi mdi-file-document" aria-hidden="true"></i>
                      </div>
                      <p>Others</p>
                    </div>
                  </div>
                  <fieldset>
                    ...
                    <div class="row form-group">
                      <div class="col-sm-6">
                        <input type="name" placeholder="Owner Name" class="form-control txt_wizard required">
                      </div>
                      <div class="col-sm-6">
                        <input type="email" placeholder="Owner Email" class="form-control txt_wizard required">
                      </div>
                    </div>
                    <div class="row form-group">
                      <div class="col-sm-6">
                        <input type="name" placeholder="Owner Contact No." class="form-control txt_wizard required">
                      </div>
                      <div class="col-sm-6">
                    ...
                    <div class="row form-group">
                      <div class="col-sm-6">
                        <input type="name" placeholder="Manager Contact No." class="form-control txt_wizard" />
                      </div>
                      <div class="col-sm-6">
                        <input type="email" placeholder="Manager Email Id " class="form-control txt_wizard" />
                      </div>
                    </div>
                    <div class="row form-group">
                      <div class="col-sm-6">
                        <input type="name" placeholder="Restaurant Name" class="form-control txt_wizard required">
                      </div>
                      <div class="col-sm-6">
                        <input type="email" placeholder="City" class="form-control txt_wizard">
                      </div>
                    </div>
                    <div class="row form-group">
                      <div class="col-sm-6">
                        <input type="name" placeholder="State" class="form-control txt_wizard">
                      </div>
                      <div class="col-sm-6">
                        <input type="email" placeholder="Website" class="form-control txt_wizard">
                      </div>
                    </div>
                    <div class="row form-group">
                      <div class="col-sm-12">
                        <textarea class="form-control glo_txtarea txt_wizard" rows="3" placeholder="Restuarent Address"></textarea>
                      </div>
                    </div>
                  ...
                  <fieldset>
                    ...
                    <div class="row form-group">
                      <div class="col-sm-6">
                        <input type="name" placeholder="Minimum Order Value" class="form-control txt_wizard">
                      </div>
                      <div class="col-sm-6">
                        <input type="name" placeholder="Name of Staff Talking Order" class="form-control txt_wizard">
                      </div>
                    </div>
                    <div class="row form-group">
                      <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        <div class="self_delivery_row">
                          ...
                          <div class="radio">
                            <input id="self_no" name="radio" type="radio" checked="" onchange="DeliverySelect(this);">
                            <label for="self_no" class="radio-label">No </label>
                          </div>
                          <div class="radio">
                            <input id="self_yes" name="radio" type="radio" onchange="DeliverySelect(this);">
                    ...
                    <div class="row form-group">
                      <div class="col-sm-6">
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <input type="email" placeholder="Start Time 08:30" class="form-control txt_wizard required">
                          </div>
                          <div class="col-sm-6">
                            <input type="email" placeholder="End Time 04:30" class="form-control txt_wizard required">
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            <input type="email" placeholder="Start Time 06:00" class="form-control txt_wizard required">
                          </div>
                          <div class="col-sm-6">
                            <input type="email" placeholder="End Time 10:30" class="form-control txt_wizard required">
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="setting image_picker">
                          ...
                          <div class="settings_wrap">
                            ...
                            <div class="settings_actions vertical">
                              <a class="disabled" data-action="remove_current_image"><i class="fa fa-trash"
                                  aria-hidden="true"></i>
                                Remove Image</a>
                            </div>
                          </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="cuisin_containner style-scroll" id="cuisin_containner">
                          <div class="cusion_row">
                            <input type="name" placeholder="Cusinis Name" class="form-control txt_wizard">
                            <button type="submit" class="cusion_btnadd" onclick="AddMoreCuisin(this);">
                  ...
                  <fieldset>
                    ...
                    <div class="row form-group">
                      <div class="col-sm-6">
                        <input type="name" placeholder="PAN / TAN Number" class="form-control txt_wizard required" />
                      </div>
                      <div class="col-sm-6">
                    ...
                    <div class="row form-group">
                      <div class="col-sm-6">
                        <input type="name" placeholder="GSTIN No." class="form-control txt_wizard required">
                      </div>
                      <div class="col-sm-6">
                        <input type="name" placeholder="GST %" class="form-control txt_wizard required">
                      </div>
                    </div>
                    <div class="form-group image-upload row">
                      <div class="col-sm-6">
