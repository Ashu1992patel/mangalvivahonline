<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
  <ul class="nav navbar-nav">
    ...
    {{-- </li> --}}
    <ul class="nav navbar-nav">
      <li><a class="top-menu-head" href="{{ url('dashboard') }}"><i class="fa fa-home" aria-hidden="true"></i>
          Home</a>
      </li>
    </ul>
    <li>
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span style="color:#fff"> Hi,
              {{ $_SESSION['admin_master']->name }}
...
<div id="wrapper">
  ...
  <div id="sidebar-wrapper">
    <div class="logo_dash_box">
      ...
      {{-- <div class="company_name">Mangal Vivah</div> --}}
    </div>
    <ul class="sidebar-nav" style="margin-left:0;">
      <li class="sidebar-brand"><a href="#menu-toggle" id="menu-toggle" style="margin-top:20px;float:right;"> <i
            class="fa fa-bars" style="font-size:30px !Important;" aria-hidden="true" aria-hidden="true"> </i> </a>
      </li>
      <li><a href="{{ url('dashboard') }}" title="Home"><i class="fa fa-home" aria-hidden="true"></i><span
            style="margin-left:10px;"> Home</span></a></li>
      <li><a href="{{ url('user_master') }}" title="All Users"><i class="fa fa-users" aria-hidden="true"></i><span
            style="margin-left:10px;"> All Profiles</span></a></li>
      <li><a href="{{ url('all_user?type=paid') }}" title="Paid Users"><i class="fa fa-child"
            aria-hidden="true"></i><span style="margin-left:10px;"> Paid Users</span></a></li>
      <li><a href="{{ url('all_user?type=unpaid') }}" title="Paid Users"><i class="fa fa-child"
            aria-hidden="true"></i><span style="margin-left:10px;"> Unpaid Users</span></a></li>
      ...
      <li><a href="{{ url('user_list?type=active') }}" title="User List"><i class="fa fa-user"
            aria-hidden="true"></i><span style="margin-left:10px;">Active Users</span></a></li>
      <li><a href="{{ url('user_list?type=inactive') }}" title="Deleted Users"><i class="fa fa-child"
            aria-hidden="true"></i><span style="margin-left:10px;"> Hold Users</span></a></li>
