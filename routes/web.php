...
Route::get('resend_code', 'User_loginController@resend_code');
...
Route::get('admingetAadhar', 'User_loginController@admingetAadhar');
...
Route::POST('admin_s_user', 'ProfileController@admin_s_user');


Route::get('mail_test', 'User_loginController@mail_test');
Route::get('testup', 'User_loginController@testup');

Route::get('e', 'ProfileController@get_error_log');
