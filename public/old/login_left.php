    ...
    <form action="index.php" method="post" name="loginForm" id="loginForm" onsubmit="return validateFields()">
      <table width="200" border="0" align="left" cellpadding="1" cellspacing="1">
        ...
        <tr>
          ...
          <td height="19" colspan="2" align="left" valign="bottom">
            <font size="1" face="Arial, Helvetica, sans-serif">
              <input name="email" title="Enter your email id or your Mangal Vivah profile id" placeholder="Email / Profile ID" style="height:13px; width:110px;" onkeypress="javascript:return chk4schar();" onkeydown="javascript: return chk4id();" size="16" maxlength="60" />
            </font>
          </td>
        </tr>
        <tr>
