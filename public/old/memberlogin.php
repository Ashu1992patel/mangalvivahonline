                            ...
                            <tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td width="100%" align="left" valign="top">
                                      <p class="onebig1"> Existing Member Login here </p>
                                    </td>
                                  </tr>
                                  <tr>
                                      ...
                                      <form action="index.php" id="loginForm" name="loginForm" method="post" onsubmit="return validateFields()">
                                        <table cellspacing="0" cellpadding="0" width="80%" align="center" border="0">
                                          <tbody>
                                            ...
                                            <tr>
                                              <td align="right">
                                                <p align="right" class="style5"><strong>Login ID :&nbsp; </strong></p>
                                              </td>
                                            ...
                                            <tr>
                                              <td height="22" align="right">
                                                <p align="right" class="style3"><strong>Password : &nbsp;</strong></p>
                                              </td>
                                            ...
                                            <tr>
                                              <td width="26%" height="15" align="right">
                                                <p>
                                                  </div>
                                                </p>
                                              </td>
                                              <td width="7%" align="left">
                                                <p>
                                                  <input title="Login" accesskey="13" onclick="return validateFields()" tabindex="3" type="submit" src="images/go1.gif" name="submit" value="Login" width="14" height="14" border="0" style="border:none" />
                                                </p>
                                              </td>
                                            ...
                                            <tr>
                                              <td colspan="3" align="left">
                                                <p>
                                                  <font face="Verdana"><span class="style7">If you are a new
                              ...
                              <td width="38%" align="right" valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td align="center" valign="middle">
                                      <p><img src="images/contact_img.jpg" width="327" height="236" /></p>
                                    </td>
                                  </tr>
