  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td align="center" valign="top">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="44%" height="234" align="center" valign="middle">
              <form action="home_quick_search.php" method="post" name="quickSearch" id="quickSearch" style="margin:0px;">
                <table width="92%" border="0" align="right" cellpadding="0" cellspacing="3">
                  ...
                  <tr>
                    ...
                    <td height="26" colspan="2" align="left" valign="middle"><select name="agefrom" class="t1" style="WIDTH: 44px">
                      ...
                      <font color="#666666" size="2" face="Verdana,Tahoma">to</font>
                      <font size="1" face="Verdana, Arial, sans-serif, Tahoma">
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                  <!--<tr>
                        <td width="25%" height="122" align="left" valign="top"><p><strong>Head Office </strong></p>
                            <p align="justify"><span class="style5">mangalvivahonline.com</span><br />
...
_________________</span></p>
                        ...
                        <td width="25%" align="left" valign="top"><p><strong>_________________ Branch</strong></p>
                            <p><span class="style5">mangalvivahonline.com</span><br />
...
Mobile: +91-_________________</span>_________________<br />
        ...
        <td width="13%" align="right" valign="top">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td height="23" align="left" valign="bottom" style="background-repeat:no-repeat;">
                <p class="style6"></p>
              </td>
            </tr>
            <tr>
              <td height="13" align="left" valign="top" style="background-repeat:no-repeat;">
            ...
            <tr>
              <td height="110" align="center" valign="top" style="background-repeat:no-repeat;">
                <a href="affiliate.php"> <button type="button">
                    <p class="style6">Affiliate Login</p>
                  </button></a>
              </td>
            </tr>
            <tr>
