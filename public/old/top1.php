    ...
    <tr>
      <td align="center" valign="top" background="images/top_bg.jpg" bgcolor="#EAE4E6" style="background-repeat:repeat-x;">
        <table width="1000" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="mainborder">
          <tr>
            <td height="50" align="left" valign="middle" bgcolor="#87004F" class="phead">
              <font face="Arial">
                <div style="float:left; width:200px; height:50px; font-size:25px;color:white;">

                </div>
                <center valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</center>
              </font>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td width="22%" height="423" align="left" valign="top">
              <table width="94%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td align="left" valign="top" bgcolor="#F2EDF3"><a href="membership.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image17','','images/membership1_h.jpg',1)"><img src="images/membership1.jpg" alt="Membership of Mangal Vivah" name="Image17" width="166" height="32" border="0" id="Image17" /></a></td>
                </tr>
                <tr>
                  <td align="left" valign="top" bgcolor="#F2EDF3"><img src="images/button_sap.jpg" width="166" height="1" /></td>
                </tr>
