...
<head>
  ...
  <title>Mangal Vivah | Partner Search</title>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td colspan="2" align="left" valign="top">
                                      <p class="style9"> Our various search tools will make your partner search much faster and easier. Go ahead and enjoy your search. </p>
                                    </td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td width="85%" align="left" valign="top">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td height="17">
                                            <p class="twobig">Quick Search </p>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <p>Search based on the&nbsp;<span class="style9"> 5 most relevant</span>&nbsp;criteria that you would look for in a partner. </p>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <p><a href="home_quick_search.php"><img src="images/qsearch.jpg" width="46" height="21" border="0" /></a></p>
                                          </td>
                                        </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td align="left" valign="top">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td height="17">
                                            <p class="twobig">Advance Search </p>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <p> Search prospective partners based on the&nbsp;<span class="style9">12 most important</span><strong>&nbsp;</strong>criteria that you would look for in a partner. </p>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <p><a href="advancesearch.php"><img src="images/qsearch.jpg" width="46" height="21" border="0" /></a></p>
                                          </td>
                                        </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td align="left" valign="top">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td height="17">
                                            <p class="twobig">Search by Profile ID </p>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>
                                            <form action="search_by_id.php" method="post" name="form1" id="form1" onsubmit="return CheckBlank()">
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">

                                                <tr>
                                                  <td width="18%" align="left" valign="middle">
                                                    <p><input name="id" id="txtLoginId" tabindex="40" size="20" accesskey="13" onkeypress="javascript:return chkspecialchars()" /></p>
                                                  </td>
                                                  <td width="82%" colspan="2" align="left" valign="middle">
                                                    <p>

                                                      Directly search member of a perticular Id.</p>
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td>
                                                    <p><input name="go" type="image" class="t2" accesskey="13" tabindex="32" title="Login" src="images/qsearch-2.jpg" /></p>
                                                  </td>
                                                </tr>
                                              </table>
                                            </form>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td align="right" valign="top">
                                      <p><img src="images/add3.gif" width="185" height="410" /></p>
                                    </td>
                                  </tr>
